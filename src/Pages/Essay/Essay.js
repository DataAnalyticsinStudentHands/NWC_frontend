    ...
    useEffect(() => {
        ...
        .then(data => {
            ...
            setState({
                ...
                section3: Section3,
                section4: Section4,
                captionedImage1: CaptionedImage1 !== null ? [VARIABLES.fetchBaseUrl, CaptionedImage1.Image.data.attributes.url].join('') : '',
                captionedImage2: CaptionedImage2 !== null ? [VARIABLES.fetchBaseUrl, CaptionedImage2.Image.data.attributes.url].join('') : '',
                captionedImage3: CaptionedImage3 !== null ? [VARIABLES.fetchBaseUrl, CaptionedImage3.Image.data.attributes.url].join('') : '',
                captionedImage4: CaptionedImage4 !== null ? [VARIABLES.fetchBaseUrl, CaptionedImage4.Image.data.attributes.url].join('') : '',
                bigImage1: BigImage1 !== null ? [VARIABLES.fetchBaseUrl, BigImage1.Image.data.attributes.url].join('') : '',
                bigImage2: BigImage2 !== null ? [VARIABLES.fetchBaseUrl, BigImage2.Image.data.attributes.url].join('') : '',
