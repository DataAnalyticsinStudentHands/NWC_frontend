...
function HowToDonatePapersForm() {
  ...
  const onSubmit = (data) => {
    ...
    fetch([import.meta.env.VITE_API_URL, `api/forms-donatepaper`].join("/"), {
      method: "POST",
      headers: {
      ...
      >
        <header>
          ...
          <p className={styles.corrections_p}>
            Are you a former NWC participant? Do you have the records of a
            family member or friend who was involved with the NWC? Would you
            like to share your materials with scholars and students interested
            in the NWC? Tell us about your materials here, and we will connect
            you with archivists who can help preserve your important work for
            generations to come.
          </p>
        </header>
