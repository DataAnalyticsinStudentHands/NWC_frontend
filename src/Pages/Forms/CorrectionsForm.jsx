...
function CorrectionsForm() {
  ...
  const onSubmit = (data) => {
    ...
    fetch([import.meta.env.VITE_API_URL, `api/forms`].join("/"), {
      method: "POST",
      headers: {
      ...
      >
        <header>
          ...
          <p className={styles.corrections_p}>
            If you detected an error on our website or have more information
            about an NWC participant that you would like to share, please tell
            us about it on this page. We will review your contribution and make
            the needed changes. We thank you in advance for your contribution to
            our work.
          </p>
